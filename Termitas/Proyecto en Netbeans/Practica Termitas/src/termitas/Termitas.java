...
public class Termitas extends PApplet {
    ...
    int alto = 200;         // Altura (en celdas) de la cuadricula.
    int ancho = 300;        // Anchura (en celdas) de la cuadricula.
    int celda = 4;          // Tamanio de cada celda cuadrada (en pixeles).
    int termitas = 100;      // Cantidad de termitas dentro del modelo.
    float densidad = 0.3f;   // Proporcion de astilla en el modelo (con probabilidad de 0 a 1).
    ...
    class ModeloTermitas {
        ...
        int direccionAleatoriaFrente(int direccion) {
            ...
            switch (rnd.nextInt(3)){
                case 0:
                    direccion = (direccion+7) % 8;
                    break;
                case 1:
                    direccion = (direccion+0) % 8;
                    break;
                case 2:
         ...
         * en otro caso.
         * Es importante mencionar que el mundo se lee mundo[Y][X] para evitar
         * exepciones de índice
         */
        ...
        void dejarAstilla(Termita t, int dir) {
            ...
            t.direccion = t.direccion + 4 % 8;
            mundo[t.posY][t.posX].estado = true;
            t.cargando = false;
            moverTermita(t,t.direccion);
        }
        ...
        void dejarAstillaConSalto(Termita t) {
            ...
            t.cargando = false;
            mundo[t.posY][t.posX].estado = true;       
            int nx = rnd.nextInt(ancho);
            int ny = rnd.nextInt(alto);            
